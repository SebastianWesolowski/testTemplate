import { __exports as server } from '../../../_virtual/server.mjs';
import { __require as requireLib } from '../../boom/lib/index.mjs';
import { __require as requireLib$1 } from '../../hoek/lib/index.mjs';
import { __require as requireLib$2 } from '../../cryptiles/lib/index.mjs';
import { __require as requireCrypto } from './crypto.mjs';
...
function requireServer () {
	...
	const Boom = requireLib();
	const Hoek = requireLib$1();
	const Cryptiles = requireLib$2();
	...
	server.authenticate = function (req, credentialsFunc, options, callback) {
	...
	*/
	...
	server.authenticatePayload = function (payload, credentials, artifacts, contentType) {
	...
	*/
	...
	server.authenticatePayloadHash = function (calculatedHash, artifacts) {
	...
	*/
	...
	server.header = function (credentials, artifacts, options) {
	...
	server.authenticateBewit = function (req, credentialsFunc, options, callback) {
	...
	server.authenticateMessage = function (host, port, message, authorization, credentialsFunc, options, callback) {
