...
import { __require as requireLib } from '../../sntp/lib/index.mjs';
import { __require as requireLib$1 } from '../../boom/lib/index.mjs';
import require$$2 from '../package.json.mjs';
...
function requireUtils () {
	...
	(function (exports) {
		...
		const Sntp = requireLib();
		const Boom = requireLib$1();
