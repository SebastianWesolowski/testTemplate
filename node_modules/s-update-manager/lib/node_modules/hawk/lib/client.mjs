import { __exports as client } from '../../../_virtual/client.mjs';
import require$$0 from 'url';
import { __require as requireLib } from '../../hoek/lib/index.mjs';
import { __require as requireLib$1 } from '../../cryptiles/lib/index.mjs';
...
function requireClient () {
	...
	const Url = require$$0;
	const Hoek = requireLib();
	const Cryptiles = requireLib$1();
	...
	*/
	...
	client.header = function (uri, method, options) {
	...
	*/
	...
	client.authenticate = function (res, credentials, artifacts, options, callback) {
	...
	*/
	...
	client.getBewit = function (uri, options) {
	...
	*/
	...
	client.message = function (host, port, message, options) {
